...
vi.mock('../array/dataArray', async (importOriginal) => {
  const actual = (await importOriginal()) as Record<string, unknown>; // Явное приведение к объекту
  return {
    ...actual,
    setLink: vi.fn(),
  };
...
describe('Form submit', () => {
  test('Calling setLink on form submit', async () => {
    ...
    expect(setLink).toHaveBeenCalledWith(testUrl)
  })
}, )